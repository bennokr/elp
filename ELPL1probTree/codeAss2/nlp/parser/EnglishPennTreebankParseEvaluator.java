...
/**
 * Evaluates precision and recall for English Penn Treebank parse trees.  
 * NOTE: Unlike the standard evaluation, multiplicity over each span is ignored.  
 * Also, punctuation is NOT currently deleted properly (approximate hack), 
 * and other normalizations (like AVDP ~ PRT) are NOT done.
 */
